...
export function Navbar() {
    return (
        ...
        hover:bg-gray-100 transition-colors duration-200">Your Closet</NavLink>
            <NavLink to="/chat" className="px-2 m-3 py-2 rounded-xl border-3 border-solid
        hover:bg-gray-100 transition-colors duration-200">Fit Suggestions</NavLink>
            <NavLink to="/saved" className="px-2 m-3 py-2 rounded-xl border-3 border-solid
        hover:bg-gray-100 transition-colors duration-200">Saved Outfits</NavLink>
        </div>
    )
}